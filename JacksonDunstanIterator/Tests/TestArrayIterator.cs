//-----------------------------------------------------------------------
// <copyright file="TestArrayIterator.cs" company="Jackson Dunstan">
...
public class TestArrayIterator
{
	...
	private int[] OneThreeThreeFour;
	private int[] OneThreeTwoFour;
	private int[] ThreeTwoOne;
	private int[] TwoThree;
	private int[] FourTwoThreeOne;
