//-----------------------------------------------------------------------
// <copyright file="TestListIterator.cs" company="Jackson Dunstan">
...
public class TestListIterator
{
	...
	private List<int> arr3;
	private List<int> arrLong;
	...
	private List<int> OneThreeThreeFour;
	private List<int> OneThreeTwoFour;
	private List<int> ThreeTwoOne;
	private List<int> TwoThree;
	private List<int> FourTwoThreeOne;
	private List<int> OneTwoThreeFour;
	...
	public void SetUp()
	{
		...
		arr3 = new int[arr.Count].ToList();
		arrLong = new int[arr.Count * 2].ToList();
		...
		OneThreeThreeFour = new List<int> { 1, 3, 3, 4 };
		OneThreeTwoFour = new List<int> { 1, 3, 2, 4 };
		ThreeTwoOne = new List<int> { 3, 2, 1 };
		TwoThree = new List<int> { 2, 3 };
		FourTwoThreeOne = new List<int> { 4, 2, 3, 1 };
		OneTwoThreeFour = new List<int> { 1, 2, 3, 4 };
	}
	...
	{
		ListIterator<int> mm1;
		ListIterator<int> mm2;
		arr.Begin().Mismatch(
			arr.End(),
			new List<int> { 1, 3, 3, 4 }.Begin(),
			AreIntsEqual,
			out mm1,
			out mm2
		);
	...
	public void Equal()
	{
		Assert.That(
			arr.Begin().Equal(
				arr.End(),
				new List<int> { 1, 3, 2, 3 }.Begin(),
				AreIntsEqual),
			Is.False);
		Assert.That(
			arr.Begin().Equal(
				arr.End(),
				new List<int> { 1, 2, 2, 3 }.Begin(),
				AreIntsEqual),
			Is.True);
	}
	...
	public void IsPermutation()
	{
		Assert.That(
			arr.Begin().IsPermutation(
				arr.End(),
				new List<int> { 3, 3, 1, 2 }.Begin(),
				AreIntsEqual),
			Is.False);
		Assert.That(
			arr.Begin().IsPermutation(
				arr.End(),
				new List<int> { 3, 2, 1, 2 }.Begin(),
				AreIntsEqual),
			Is.True);
	}
	...
	{
		ListIterator<int> outResultTrue;
		ListIterator<int> outResultFalse;
	...
	{
		ListIterator<int> equalRangeLower;
		ListIterator<int> equalRangeUpper;
	...
	{
		ListIterator<int> copyResult = arr.Begin().Copy(
			arr.End(),
			arrLong.Begin());
	...
	{
		ListIterator<int> minIt;
		ListIterator<int> maxIt;
